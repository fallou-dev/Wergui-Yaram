...
<body>
  <div id="entete">Gestion des Consultations</div>
  <div id="menu">
  
     <ul>
     <li><a href="<%= APP_ROOT  %>/listeconsultation">Acceuil</a></li>
     <li><a href="<%= APP_ROOT  %>/listeconsultation">Lister</a></li>
     <li><a href="<%= APP_ROOT  %>/insertconsultation">Ajouter</a></li>
     </ul>
  </div>
