...
public class AddPatientForm {
	...
	private static final String CHAMP_Situation_familliale ="situatuion_familliale";
	...
	public boolean ajouter() 
	{
		...
		this.patient = new Patient(nom_patient,prenom_patient,email,motdepasse,telephone,date_de_naissance,sexe,adresse,situation_familliale,personne_a_prevenir,tel_personne_a_prevenir,valide_compte);
		...
		if(this.erreurs.isEmpty()) {
			Patient_dao.insertUser(patient);
			this.status = true;
